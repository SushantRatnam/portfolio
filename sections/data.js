export const projects = {
  summarizer: {
    id: 'summarizer',
    name: 'Summarizer',
    description: 'Summarizer - Convert audio/video to summarized text',
    url: 'https://magenta-taiyaki-d1a5df.netlify.app/',
    images: [
      {
        id: '0',
        src: '/summarizer.png',
        srcPng: '/summarizer.png',
        wdith: '221',
        height: '134',
        description:
          'Your solution for condensing lengthy Zoom meetings and YouTube videos into concise summaries and transcripts, complete with key keywords for easy categorization and reference',
      },
      {
        id: '1',
  ...
  chatApp: {
    ...
    description: 'Live chat app using websockets',
    images: [
      {
        id: '0',
        wdith: '2214',
        ...
        srcPng: '/chat-app.png',
        description:
          'A chat app where users can create rooms and have live chat with each other. It uses websockets to communicate with the server and built using nodeJs and expressJs. Profanity filter is implemented.',
      },
    ],
  },
};
