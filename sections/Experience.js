...
function JobCard({ job, children }) {
  return (
    <div className="pb-8 mx-4 md:mx-8 md:text-center sm:text-left">
      ...
      <h4 className="mb-2 font-semibold leading-6 text-gray-500">
        {job.duration}
      </h4>
  ...
  return (
    <Section anchor="experience">
      <div className="max-w-2xl mx-auto">
        ...
        >
          As a Software Engineer(Frontend), I was responsible for the
          development and maintainance of our internal CMS which is used to
          create ecommerce websites for our clients. It helped us to create
          multi tenant websites where SEO was of utmost importance. We leveraged
          SSR and SSG capabilities of NextJs to create best in class
          performance.
        </JobCard>
        <JobCard
          job={{
        ...
        >
          As a junior dev, My role was to take inputs from the client and
          translate that to technical requirements. I create UI for any new
          features and also improve the existing functionality using ReactJs.
        </JobCard>
      </div>
    </Section>
  );
